...
#Cambiar la base utilizada por la que viene en el examen
base1 = base
...
#Ligeras Modificaciones en las proporciones debido a la base del examen 
...
likert(nivel.educativo ~.,  ReferenceZero = 3, data = base_virtu, ylab = "Nivel Educativo", xlab = "", main = "" )
```
...
#Como utilizamos la nueva base las proporciones cambian ligeramente
base_virtu = data.frame(   nivel.educativo = c('Primaria', 'Secundaria', 'Universidad'),
...
nodes = list( list(id = 'Estudiar',
                    id = 'NS/NR',
                    id = 'Trabajar',
                    id = ' Trabajar y Estudiar',
                    id = 'Estudiar',
                    id = 'No retorna',
                    id = 'NS/NR',
                    id = 'Trabajar',
                    id = 'Trabar y estudiar') ) )
